...
| ----- | ----- | -------- |
| `funcionario-brainstorming` | Analyst | Brainstorm cho dự án mới |
| `funcionario-prd` | PM | Tạo tài liệu yêu cầu sản phẩm |
```
...
Có. Workflow `funcionario-correct-course` xử lý thay đổi phạm vi giữa chừng.
