---
title: "Jak přizpůsobit Funcionário Infinito"
...
:::note[Předpoklady]
- Funcionário Infinito nainstalován ve vašem projektu (viz [Jak nainstalovat Funcionário Infinito](./install-funcionario.md))
...
```text
_funcionario/_config/agents/
├── core-funcionario-master.customize.yaml
...
| **Modify Funcionário Infinito Installation** | Plný instalační postup pro přidání nebo odebrání modulů                |
...
- Spusťte `npx funcionario-method install` a vyberte **Quick Update** pro aplikaci změn
...
- Spusťte `npx funcionario-method install` a vyberte **Quick Update** pro obnovení výchozích hodnot

## Přizpůsobení workflow

Přizpůsobení existujících Funcionário Infinito workflow a skills přijde brzy.
