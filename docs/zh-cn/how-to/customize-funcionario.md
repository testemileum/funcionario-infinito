---
title: "如何自定义 Funcionário Infinito"
...
| **Modify Funcionário Infinito Installation** | 进入完整安装流程，用于增删模块 |
...
- 运行 `npx funcionario-method install` 并选择 **Quick Update** 以应用更改
...
- 运行 `npx funcionario-method install` 并选择 **Quick Update** 以恢复默认设置

## 工作流自定义

对现有 Funcionário Infinito 工作流和技能的深度自定义能力即将推出。
