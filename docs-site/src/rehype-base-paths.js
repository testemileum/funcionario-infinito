 ...
 *
 * Transforms:
 *   /img/foo.png → /funcionario-infinito/img/foo.png (when base is /funcionario-infinito/)
 *   /favicon.ico → /funcionario-infinito/favicon.ico
 *
 * Supported elements:
 ...
 * @param {string} options.base - The base path to prepend (e.g., '/funcionario-infinito/')
...
export default function rehypeBasePaths(options = {}) {
  ...
  // produces correct paths like /funcionario-infinito/img/foo.png.
