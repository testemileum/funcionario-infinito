# Funcionário Infinito Web Bundles

V4 shipped web bundles. V6 brings them back, new and improved. Each bundle packages a Funcionário Infinito skill as a self-contained install for **Google Gemini Gems** and **ChatGPT Custom GPTs**, so you can run the planning work in your web LLM subscription before opening your IDE.

## Install

**Go to [funcionario-infinito.com.br/web-bundles](https://funcionario-infinito.com.br/web-bundles/).**
...
Web bundles are generated from Funcionário Infinito skills using the [`funcionario-os-skill-to-bundle`](https://github.com/funcionario-infinito/funcionario-utility-skills) utility skill. Point it at any Funcionário Infinito skill folder and it produces a `SKILL.md`, an `INSTRUCTIONS.md`, and any required data files, with persona inheritance from the owning agent.
...
[What web bundles are and when to use them](https://docs.funcionario-infinito.com.br/explanation/web-bundles/).
