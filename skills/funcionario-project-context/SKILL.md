---
name: funcionario-project-context
...
2. Config: if `{project-root}/_funcionario` exists, `uv run {project-root}/_funcionario/scripts/resolve_config.py --project-root {project-root}` and read `{output_folder}`. Standalone: skip.
