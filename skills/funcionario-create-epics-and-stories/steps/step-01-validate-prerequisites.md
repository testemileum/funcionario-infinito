...
1. `{planning_artifacts}/ux-designs/ux-*/DESIGN.md` and `{planning_artifacts}/ux-designs/ux-*/EXPERIENCE.md` (funcionario-ux spine pair)
2. `{planning_artifacts}/*ux*.md` (legacy whole document)
3. `{planning_artifacts}/*ux*/index.md` (legacy sharded version)

For each matching funcionario-ux run folder, treat `DESIGN.md` and `EXPERIENCE.md` as one UX design contract:
...
Read the FULL UX design contract and extract ALL actionable work items. For a funcionario-ux spine pair, read both `DESIGN.md` and `EXPERIENCE.md`:
