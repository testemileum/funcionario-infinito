...
funcionario-advanced-elicitation's pick_methods.py.)
...
<title>Funcionário Infinito Brainstorming Selection</title>
<script>
/* set the theme before first paint so there's no light-mode flash */
(function(){ try {
  var t = localStorage.getItem('funcionario-theme');
...
<header>
  <div class="hwrap">
  <div class="titlerow">
    <h1>Funcionário Infinito Brainstorming Selection</h1>
...
<footer>Funcionário Infinito &middot; Brainstorming</footer>
<script>
(function(){
  ...
  themeBtn.addEventListener('click', function(){
    ...
    try { localStorage.setItem('funcionario-theme', next); } catch(e){}
    setThemeIcon();
  });
