...
```json
{
  "status": "complete",
  "files": [
    "_funcionario-output/specs/spec-quarter-drop/SPEC.md",
    "_funcionario-output/specs/spec-quarter-drop/glossary.md",
    "_funcionario-output/specs/spec-quarter-drop/.memlog.md"
  ]
}
```
...
```json
{
  ...
  "reason": "Input was a one-line idea with no surrounding context; too thin to distill. Suggest funcionario-prd to draw the vision out first."
}
```
